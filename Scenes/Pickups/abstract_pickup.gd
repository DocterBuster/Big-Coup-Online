...
func _physics_process(delta: float) -> void:
	...
	## Lerp to position of held player 
...
## Called to set a new player holding this pickup
@rpc("any_peer", "call_local", "reliable")
func player_pickup(player_id : String) -> void:
	is_held = true
	...
	self.freeze = true
	_set_authority(player_holding_id)


## Called to release the pickup being held
@rpc("any_peer", "call_local", "reliable")
func player_drop():
	is_held = false
	## Return Auth to host
...
func _set_authority(new_peer_id: int) -> void:
